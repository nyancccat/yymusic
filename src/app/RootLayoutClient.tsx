    ...
    <div className="relative flex h-screen h-[100dvh] w-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1">
          <main className="relative flex-1 overflow-y-auto px-3 pb-[calc(var(--bottom-space)+env(safe-area-inset-bottom))] pt-5 md:px-8 md:pt-6">
            ...
            <div className="relative pt-3 md:pt-1">{children}</div>
          </main>
